...
namespace Registar
{
    ...
    {//lista list sluzi za umetanje podataka iz baze podatkaka u grid
        //
        //lista novo sluzi za unos podataka u listu preko text boxa ili mozda radnom broj 
      ...
      List<string> list = new List<string>();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("POGLEDAJ KOD== TIPKA JOS U IZRADI");
        }
        ...
        {// sluzi za testiranje
            ...
            novo.Add("127474747474747");
            novo.Add("127474747474747");
            MessageBox.Show(Reg.Text.Length.ToString());
            ...
            if (Reg.Text.Length == 15)
            {
                ...
                //ISPOD SU POKUSAJI KOJI MOZDA BUDU KORISNI
